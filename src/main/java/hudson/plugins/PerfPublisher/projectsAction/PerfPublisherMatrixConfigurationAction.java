 ...
 *
 */
public class PerfPublisherMatrixConfigurationAction extends AbstractPerfPublisherAction {

	private MatrixConfiguration project;
	
	public PerfPublisherMatrixConfigurationAction(MatrixConfiguration project) {
		this.project = project;
	}

	public String getDisplayName() {
		return PerfPublisherPlugin.MATRIX_CONFIGURATION_DISPLAY_NAME;
	}
