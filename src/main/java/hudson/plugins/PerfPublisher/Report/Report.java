...
public class Report {
    ...
    public String toString() {
        ...
        resultat += "\n----------------------------------------------";
        StringBuilder resultatBuilder1 = new StringBuilder(resultat);
        for (Test test : tests) {
            resultatBuilder1.append("\n----------------------------------------------");
            resultatBuilder1.append("\nTest name : ").append(test.getName());
            StringBuilder resultatBuilder = new StringBuilder(resultatBuilder1.toString());
            for (int j = 0; j < test.getCommandLine().size(); j++) {
                resultatBuilder.append("\nCommand line : ").append(test.getCommandLine().get(j).getCommand()).append(" (").append(test.getCommandLine().get(j).getTime()).append(")");
            }
            resultatBuilder1 = new StringBuilder(resultatBuilder.toString());

            resultatBuilder1.append("\nState success : ").append(test.getSuccess().getState());
        }
        resultat = resultatBuilder1.toString();
        return resultat;
    }
